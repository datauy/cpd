...
(function(win, doc) {
	'use strict';
	var apiKey = 'AIzaSyDprurGS1unM_jPA24BiG9WeK-hLsFmBYM'; //Clave de API youtube CPD
			...
			prepare = {
				...
				build: function(){
					...
					if(settings.listTheme == 'light'){
						utils.addCSS( ' #'+id+'.ytv-canvas{background: #fff; width: 90%; margin: 0 auto;}'
							...
							+ ' #'+id+' .ytv-playlists{background: #fff;}'
							);
					}
				},
